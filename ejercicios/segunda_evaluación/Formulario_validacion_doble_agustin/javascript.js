...
function validar(e) {
    ...
    this.disabled = true; // this hace referencia al boton que activo la funcion
...
function validarMatricula() {
    ...
    let regExp = /^\d{4}\s[A-Z]{3}$/; // cuatro dígitos seguidos de un espacio en blanco y luego tres letras mayúsculas
