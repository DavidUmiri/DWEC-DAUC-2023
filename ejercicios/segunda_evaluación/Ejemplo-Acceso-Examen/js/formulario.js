...
document.getElementById("id_input_text").addEventListener("click", (event) => {
  ...
  // this.document.forms["id_form"]["id_input_text"].value = prompt("Introduce tu nombre: ");

  console.log(this.document.forms["id_form"].elements["id_input_text"].value);
});
...
document.forms[0]["reset"].addEventListener("click", function () {
  ...
  document.getElementById("id_form").style.backgroundColor = "white"; // lo colocamos en blanco cuando borramos
});
...
document.forms[0].addEventListener("submit", (event) => {
  ...
  for (let e of document.forms[0].elements) {
    ...
    // TODO: condición de que si el valor es vacío no recoja los datos
