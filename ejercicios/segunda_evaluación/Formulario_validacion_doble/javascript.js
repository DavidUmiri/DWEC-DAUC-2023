...
function validarEdad() {
    ...
    if (inputEdad.value == "") {
        ...
        document.getElementById("idEdadError").innerHTML = "La edad debe ser entre 1 y 100"
        return false;
    }
    return true;
}
...
function validarApellidosHTML() {
    ...
    if (inputApellidos.validity.valueMissing) {
        ...
        inputApellidos.setCustomValidity("El campo se encuentra vacío")
        document.getElementById("idApellidosError").innerHTML = inputApellidos.validationMessage;
        return false;
    }
    return true;
}
